...
Once the process completes, PIE launches automatically and loads the target map.
The Content Drawer location containing the map data is also opened automatically, giving you immediate access to the assets.
